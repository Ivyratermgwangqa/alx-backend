...
const jobs = [
  ...
  { phoneNumber: '4151318781', message: 'This is the code 4562 to verify your account' },
  { phoneNumber: '4151418782', message: 'This is the code 4321 to verify your account' },
  { phoneNumber: '4151518781', message: 'This is the code 4562 to verify your account' },
  { phoneNumber: '4151618782', message: 'This is the code 4321 to verify your account' }
];
...
jobs.forEach((jobData, index) => {
  const job = queue.create('push_notification_code_2', jobData)
    .save((err) => {
      if (err) {
        console.log(`Error creating job ${index + 1}:`, err);
      } else {
